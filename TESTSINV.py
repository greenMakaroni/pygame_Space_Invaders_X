...
def welcome_screen():
    ...
    while welcome:
        ...
        button(green_button_state, 200, 248, 400, 44, white, blue1, main_loop)      
        button(" Q U I T ", 200, 500, 400, 45, white, blue1, quitgame)

        if player_health != 5:
            button(" R E S E T ", 200, 376, 400, 44, white, blue1, main_loop)
...
##    global bulletX
##    global bulletY
##    global enemy_bulletX[i]
##    global enemy_bulletY[i]
...
def healthbar(playerX, playerY, player_health):
    ...
    for i in range(player_health):
            if i >= 10:
                ...
                pygame.draw.rect(screen, blue,(playerX + ((i - 5) * 8) +6, playerY + 50 , 6, 6))
            else:           
